...
export default function DespesaPorCategoria({ navigation }) {
    ...
    const despesaFiltrada = despesasDaCategoria.filter(despesasDaCategoria => despesasDaCategoria.categoriaId === categoria.categoriaId)
    ...
    return (
        <View style={styles.container}>
            ...
            {isLoading ? (
                ...
                {despesaFiltrada.map((despesa, categoria) => (
                <View style={styles.despesacard}>
                    <View style={styles.suo}>
                        ...
                        <Text style={styles.datadespesa}>
                            {despesa.data ? dayjs(despesa.data).format("DD MMM") : ""} - 22:12h
                        </Text>
                    </View>
